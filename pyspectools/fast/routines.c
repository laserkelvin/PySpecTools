...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "pyspectools.fast.routines",
        "sources": [
            "/Users/kelvin/Documents/Python/PySpecTools/pyspectools/fast/routines.pyx"
        ]
    },
    "module_name": "pyspectools.fast.routines"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyspectools__fast__routines
#define __PYX_HAVE_API__pyspectools__fast__routines
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* "pyspectools/fast/routines.pyx":6
 * cimport cython
 * 
 ...
 * """
 */
typedef __pyx_t_5numpy_uint8_t __pyx_t_11pyspectools_4fast_8routines_uint8;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
struct __pyx_opt_args_11pyspectools_4fast_8routines_isin_array;

/* "pyspectools/fast/routines.pyx":19
...
/* Module declarations from 'pyspectools.fast.routines' */
...
static PyObject *__pyx_f_11pyspectools_4fast_8routines_isin_array(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch, struct __pyx_opt_args_11pyspectools_4fast_8routines_isin_array *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "pyspectools.fast.routines"
extern int __pyx_module_is_main_pyspectools__fast__routines;
int __pyx_module_is_main_pyspectools__fast__routines = 0;

/* Implementation of 'pyspectools.fast.routines' */
...
static PyObject *__pyx_pf_11pyspectools_4fast_8routines_isin_array(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_tol); /* proto */
...
static PyObject *__pyx_pw_11pyspectools_4fast_8routines_1isin_array(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_8routines_isin_array(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_11pyspectools_4fast_8routines_isin_array *__pyx_optional_args) {
  double __pyx_v_tol = ((double)1e-2);
  int __pyx_v_i;
  int __pyx_v_j;
  __pyx_t_11pyspectools_4fast_8routines_uint8 __pyx_v_check;
  double __pyx_v_a_val;
  CYTHON_UNUSED double __pyx_v_b_val;
  int __pyx_v_a_n;
  int __pyx_v_b_n;
  PyArrayObject *__pyx_v_check_array = 0;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_check_array;
  __Pyx_Buffer __pyx_pybuffer_check_array;
  ...
  __Pyx_RefNannySetupContext("isin_array", 0);
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_tol = __pyx_optional_args->tol;
    }
  }
  __pyx_pybuffer_check_array.pybuffer.buf = NULL;
  __pyx_pybuffer_check_array.refcount = 0;
  __pyx_pybuffernd_check_array.data = NULL;
  __pyx_pybuffernd_check_array.rcbuffer = &__pyx_pybuffer_check_array;

  /* "pyspectools/fast/routines.pyx":46
 ...
 */
  ...
  /* "pyspectools/fast/routines.pyx":47
 *     """
 *     cdef int i, j = 0
 *     cdef uint8 check = False             # <<<<<<<<<<<<<<
 *     cdef double a_val, b_val = 0.
 ...
 */
  ...
  /* "pyspectools/fast/routines.pyx":48
 *     cdef int i, j = 0
 *     cdef uint8 check = False
 *     cdef double a_val, b_val = 0.             # <<<<<<<<<<<<<<
 *     cdef int a_n = a.shape[0]
 ...
 */
  ...
  /* "pyspectools/fast/routines.pyx":49
 *     cdef uint8 check = False
 *     cdef double a_val, b_val = 0.
 *     cdef int a_n = a.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int b_n = b.shape[0]
 ...
 */
  __pyx_v_a_n = (__pyx_v_a.shape[0]);

  /* "pyspectools/fast/routines.pyx":50
 *     cdef double a_val, b_val = 0.
 *     cdef int a_n = a.shape[0]
 *     cdef int b_n = b.shape[0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.uint8_t, ndim=1] check_array = np.zeros(
 *         a_n, dtype=np.uint8
 */
  __pyx_v_b_n = (__pyx_v_b.shape[0]);

  /* "pyspectools/fast/routines.pyx":51
 *     cdef int a_n = a.shape[0]
 *     cdef int b_n = b.shape[0]
 *     cdef np.ndarray[np.uint8_t, ndim=1] check_array = np.zeros(             # <<<<<<<<<<<<<<
 *         a_n, dtype=np.uint8
 ...
 */
  ...
  /* "pyspectools/fast/routines.pyx":52
 *     cdef int b_n = b.shape[0]
 *     cdef np.ndarray[np.uint8_t, ndim=1] check_array = np.zeros(
 *         a_n, dtype=np.uint8             # <<<<<<<<<<<<<<
 *     )
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_a_n); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_5);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_check_array.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_check_array = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_check_array.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 51, __pyx_L1_error)
    } else {__pyx_pybuffernd_check_array.diminfo[0].strides = __pyx_pybuffernd_check_array.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_check_array.diminfo[0].shape = __pyx_pybuffernd_check_array.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_6 = 0;
  __pyx_v_check_array = ((PyArrayObject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "pyspectools/fast/routines.pyx":55
 *     )
 *     # Outer loop on all of elements in a
 *     for i in range(a_n):             # <<<<<<<<<<<<<<
 *         # Get value of a
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "pyspectools/fast/routines.pyx":57
 *     for i in range(a_n):
 *         # Get value of a
 *         a_val = a[i]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_v_a_val = (*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_10 * __pyx_v_a.strides[0]) )));

    /* "pyspectools/fast/routines.pyx":59
 *         a_val = a[i]
 *         # Inner loop on all of b
 *         for j in range(b_n):             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_11 = __pyx_v_b_n;
    __pyx_t_12 = __pyx_t_11;
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      __pyx_v_j = __pyx_t_13;

      /* "pyspectools/fast/routines.pyx":60
 *         # Inner loop on all of b
 *         for j in range(b_n):
 *             check = abs(a_val - b[j]) <= tol             # <<<<<<<<<<<<<<
 *             # See if values meet the tolerance
 ...
 */
      ...
      __pyx_v_check = (fabs((__pyx_v_a_val - (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_14 * __pyx_v_b.strides[0]) ))))) <= __pyx_v_tol);

      /* "pyspectools/fast/routines.pyx":62
 *             check = abs(a_val - b[j]) <= tol
 *             # See if values meet the tolerance
 *             if check == 1:             # <<<<<<<<<<<<<<
 *                 check_array[i] = 1
 *             else:
 */
      __pyx_t_15 = ((__pyx_v_check == 1) != 0);
      if (__pyx_t_15) {

        /* "pyspectools/fast/routines.pyx":63
 *             # See if values meet the tolerance
 *             if check == 1:
 *                 check_array[i] = 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_check_array.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_check_array.diminfo[0].strides) = 1;
 ...
 */
      ...
      /* "pyspectools/fast/routines.pyx":65
 *                 check_array[i] = 1
 *             else:
 *                 continue             # <<<<<<<<<<<<<<
 *     return check_array
 */
  ...
  /* "pyspectools/fast/routines.pyx":66
 *             else:
 *                 continue
 *     return check_array             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __Pyx_INCREF(((PyObject *)__pyx_v_check_array));
  __pyx_r = ((PyObject *)__pyx_v_check_array);
  goto __pyx_L0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_check_array.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("pyspectools.fast.routines.isin_array", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_check_array.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_check_array);
...
static PyObject *__pyx_pw_11pyspectools_4fast_8routines_1isin_array(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("isin_array (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("isin_array", 0, 2, 3, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "isin_array") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_b.memview)) __PYX_ERR(0, 19, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_tol = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("isin_array", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyspectools.fast.routines.isin_array", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11pyspectools_4fast_8routines_isin_array(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_tol);
...
static PyObject *__pyx_pf_11pyspectools_4fast_8routines_isin_array(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, double __pyx_v_tol) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_11pyspectools_4fast_8routines_isin_array __pyx_t_2;
  __Pyx_RefNannySetupContext("isin_array", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 19, __pyx_L1_error) }
  if (unlikely(!__pyx_v_b.memview)) { __Pyx_RaiseUnboundLocalError("b"); __PYX_ERR(0, 19, __pyx_L1_error) }
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.tol = __pyx_v_tol;
  __pyx_t_1 = __pyx_f_11pyspectools_4fast_8routines_isin_array(__pyx_v_a, __pyx_v_b, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pyspectools.fast.routines.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyspectools.fast.routines.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyspectools.fast.routines.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyspectools.fast.routines._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"isin_array", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11pyspectools_4fast_8routines_1isin_array, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11pyspectools_4fast_8routines_isin_array},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pyspectools__fast__routines) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyspectools.fast.routines")) {
      if (unlikely(PyDict_SetItemString(modules, "pyspectools.fast.routines", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pyspectools/fast/routines.pyx":2
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyspectools.fast.routines", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyspectools.fast.routines");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
