...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "pyspectools.fast.lineshapes",
        "sources": [
            "/Users/kelvin/Documents/Python/PySpecTools/pyspectools/fast/lineshapes.pyx"
        ]
    },
    "module_name": "pyspectools.fast.lineshapes"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyspectools__fast__lineshapes
#define __PYX_HAVE_API__pyspectools__fast__lineshapes
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'pyspectools.fast.lineshapes' */
...
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_gaussian(__Pyx_memviewslice, double, double, double, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_multi_gaussian(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_pair_gaussian(__Pyx_memviewslice, float, float, float, float, float, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_lorentzian(__Pyx_memviewslice, float, float, float, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_first_deriv_lorentzian(__Pyx_memviewslice, float, float, float, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_sec_deriv_lorentzian(__Pyx_memviewslice, float, float, float, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pyspectools.fast.lineshapes"
extern int __pyx_module_is_main_pyspectools__fast__lineshapes;
int __pyx_module_is_main_pyspectools__fast__lineshapes = 0;

/* Implementation of 'pyspectools.fast.lineshapes' */
...
static const char __pyx_k_xsep[] = "xsep";
...
static PyObject *__pyx_n_s_xsep;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_gaussian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_A, double __pyx_v_x0, double __pyx_v_w); /* proto */
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_2multi_gaussian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_x0, __Pyx_memviewslice __pyx_v_w); /* proto */
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_4pair_gaussian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_A1, float __pyx_v_A2, float __pyx_v_x0, float __pyx_v_w, float __pyx_v_xsep); /* proto */
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_6lorentzian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_x0, float __pyx_v_gamma, float __pyx_v_A); /* proto */
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_8first_deriv_lorentzian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_x0, float __pyx_v_gamma, float __pyx_v_A); /* proto */
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_10sec_deriv_lorentzian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_x0, float __pyx_v_gamma, float __pyx_v_A); /* proto */
...
/* "pyspectools/fast/lineshapes.pyx":25
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_1gaussian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_gaussian(__Pyx_memviewslice __pyx_v_x, double __pyx_v_A, double __pyx_v_x0, double __pyx_v_w, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "pyspectools/fast/lineshapes.pyx":54
 *     """
 ...
 */
  ...
  /* "pyspectools/fast/lineshapes.pyx":55
 *     cdef unsigned int index
 *     cdef unsigned int n = x.shape[0]
 *     cdef double[:] y = np.zeros(n)             # <<<<<<<<<<<<<<
 *     for index in range(n):
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  /* "pyspectools/fast/lineshapes.pyx":56
 *     cdef unsigned int n = x.shape[0]
 *     cdef double[:] y = np.zeros(n)
 *     for index in range(n):             # <<<<<<<<<<<<<<
 *         y[index] = exp(-(x[index] - x0)**2. / (2. * w**2.))
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "pyspectools/fast/lineshapes.pyx":57
 *     cdef double[:] y = np.zeros(n)
 *     for index in range(n):
 *         y[index] = exp(-(x[index] - x0)**2. / (2. * w**2.))             # <<<<<<<<<<<<<<
 *         y[index] *= (A / sqrt(2. * pi * w**2.))
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_10 * __pyx_v_y.strides[0]) )) = exp(((-pow(((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_9 * __pyx_v_x.strides[0]) ))) - __pyx_v_x0), 2.)) / (2. * pow(__pyx_v_w, 2.))));

    /* "pyspectools/fast/lineshapes.pyx":58
 *     for index in range(n):
 *         y[index] = exp(-(x[index] - x0)**2. / (2. * w**2.))
 *         y[index] *= (A / sqrt(2. * pi * w**2.))             # <<<<<<<<<<<<<<
 *     #y = exp(-(x - x0)**2. / (2. * w**2.))
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_11 * __pyx_v_y.strides[0]) )) *= (__pyx_v_A / sqrt(((2. * M_PI) * pow(__pyx_v_w, 2.))));
  }

  /* "pyspectools/fast/lineshapes.pyx":61
 *     #y = exp(-(x - x0)**2. / (2. * w**2.))
 *     #y *= (A / sqrt(2. * pi * w**2.))
 *     return y             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_y, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.gaussian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_1gaussian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_A,&__pyx_n_s_x0,&__pyx_n_s_w,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("gaussian", 1, 4, 4, 1); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gaussian", 1, 4, 4, 2); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gaussian", 1, 4, 4, 3); __PYX_ERR(0, 25, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "gaussian") < 0)) __PYX_ERR(0, 25, __pyx_L3_error)
      }
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_A = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_A == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_x0 = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_x0 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_w = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_w == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("gaussian", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.gaussian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11pyspectools_4fast_10lineshapes_gaussian(__pyx_self, __pyx_v_x, __pyx_v_A, __pyx_v_x0, __pyx_v_w);
...
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_gaussian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, double __pyx_v_A, double __pyx_v_x0, double __pyx_v_w) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("gaussian", 0);
  ...
  __pyx_t_1 = __pyx_f_11pyspectools_4fast_10lineshapes_gaussian(__pyx_v_x, __pyx_v_A, __pyx_v_x0, __pyx_v_w, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pyspectools/fast/lineshapes.pyx":68
 * @cython.cdivision(True)
 * @cython.nonecheck(False)
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_3multi_gaussian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_multi_gaussian(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_x0, __Pyx_memviewslice __pyx_v_w, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  size_t __pyx_t_19;
  size_t __pyx_t_20;
  __Pyx_RefNannySetupContext("multi_gaussian", 0);

  /* "pyspectools/fast/lineshapes.pyx":88
 *     """
 ...
 *     cdef double[:] y = np.zeros(n)
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_x, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __Pyx_PyInt_As_unsigned_int(__pyx_t_2); if (unlikely((__pyx_t_3 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_n = __pyx_t_3;

  /* "pyspectools/fast/lineshapes.pyx":89
 *     cdef unsigned int i, j
 *     cdef unsigned int n = x.size
 *     cdef unsigned int m = x0.size             # <<<<<<<<<<<<<<
 *     cdef double[:] y = np.zeros(n)
 ...
 */
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_x0, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_size); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __Pyx_PyInt_As_unsigned_int(__pyx_t_1); if (unlikely((__pyx_t_3 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_m = __pyx_t_3;

  /* "pyspectools/fast/lineshapes.pyx":90
 *     cdef unsigned int n = x.size
 *     cdef unsigned int m = x0.size
 *     cdef double[:] y = np.zeros(n)             # <<<<<<<<<<<<<<
 *     # Make sure that the size of the parameter arrays are equal
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_zeros); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 90, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 90, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = NULL;
  ...
  /* "pyspectools/fast/lineshapes.pyx":92
 *     cdef double[:] y = np.zeros(n)
 *     # Make sure that the size of the parameter arrays are equal
 *     assert A.size == x0.size == w.size             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_A, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_size); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_x0, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = PyObject_RichCompare(__pyx_t_4, __pyx_t_2, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 92, __pyx_L1_error)
    if (__Pyx_PyObject_IsTrue(__pyx_t_1)) {
      __Pyx_DECREF(__pyx_t_1);
      __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_w, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 92, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_size); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 92, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_1 = PyObject_RichCompare(__pyx_t_2, __pyx_t_7, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 92, __pyx_L1_error)
  ...
  /* "pyspectools/fast/lineshapes.pyx":94
 *     assert A.size == x0.size == w.size
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         for j in range(m):
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "pyspectools/fast/lineshapes.pyx":95
 * 
 *     for i in range(n):
 *         for j in range(m):             # <<<<<<<<<<<<<<
 *             y[i] += (A[j] / sqrt(2. * pi * w[j]**2.))
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      ...
      /* "pyspectools/fast/lineshapes.pyx":96
 *     for i in range(n):
 *         for j in range(m):
 *             y[i] += (A[j] / sqrt(2. * pi * w[j]**2.))             # <<<<<<<<<<<<<<
 *             y[i] *= exp(-(x[i] - x0[j])**2. / (2. * w[j]**2.))
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_16 * __pyx_v_y.strides[0]) )) += ((*((double *) ( /* dim=0 */ (__pyx_v_A.data + __pyx_t_14 * __pyx_v_A.strides[0]) ))) / sqrt(((2. * M_PI) * pow((*((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_15 * __pyx_v_w.strides[0]) ))), 2.))));

      /* "pyspectools/fast/lineshapes.pyx":97
 *         for j in range(m):
 *             y[i] += (A[j] / sqrt(2. * pi * w[j]**2.))
 *             y[i] *= exp(-(x[i] - x0[j])**2. / (2. * w[j]**2.))             # <<<<<<<<<<<<<<
 *     return y
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_20 * __pyx_v_y.strides[0]) )) *= exp(((-pow(((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_17 * __pyx_v_x.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_x0.data + __pyx_t_18 * __pyx_v_x0.strides[0]) )))), 2.)) / (2. * pow((*((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_19 * __pyx_v_w.strides[0]) ))), 2.))));
    }
  }

  /* "pyspectools/fast/lineshapes.pyx":98
 *             y[i] += (A[j] / sqrt(2. * pi * w[j]**2.))
 *             y[i] *= exp(-(x[i] - x0[j])**2. / (2. * w[j]**2.))
 *     return y             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_y, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 98, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.multi_gaussian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_y, 1);
  __Pyx_XGIVEREF(__pyx_r);
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_3multi_gaussian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("multi_gaussian (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_A,&__pyx_n_s_x0,&__pyx_n_s_w,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("multi_gaussian", 1, 4, 4, 1); __PYX_ERR(0, 68, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("multi_gaussian", 1, 4, 4, 2); __PYX_ERR(0, 68, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("multi_gaussian", 1, 4, 4, 3); __PYX_ERR(0, 68, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "multi_gaussian") < 0)) __PYX_ERR(0, 68, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 68, __pyx_L3_error)
    __pyx_v_A = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_A.memview)) __PYX_ERR(0, 68, __pyx_L3_error)
    __pyx_v_x0 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x0.memview)) __PYX_ERR(0, 68, __pyx_L3_error)
    __pyx_v_w = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_w.memview)) __PYX_ERR(0, 68, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("multi_gaussian", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 68, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.multi_gaussian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11pyspectools_4fast_10lineshapes_2multi_gaussian(__pyx_self, __pyx_v_x, __pyx_v_A, __pyx_v_x0, __pyx_v_w);
...
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_2multi_gaussian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_x0, __Pyx_memviewslice __pyx_v_w) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("multi_gaussian", 0);
  ...
  if (unlikely(!__pyx_v_A.memview)) { __Pyx_RaiseUnboundLocalError("A"); __PYX_ERR(0, 68, __pyx_L1_error) }
  if (unlikely(!__pyx_v_x0.memview)) { __Pyx_RaiseUnboundLocalError("x0"); __PYX_ERR(0, 68, __pyx_L1_error) }
  if (unlikely(!__pyx_v_w.memview)) { __Pyx_RaiseUnboundLocalError("w"); __PYX_ERR(0, 68, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_11pyspectools_4fast_10lineshapes_multi_gaussian(__pyx_v_x, __pyx_v_A, __pyx_v_x0, __pyx_v_w, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pyspectools/fast/lineshapes.pyx":105
 * @cython.cdivision(True)
 * @cython.nonecheck(False)
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_5pair_gaussian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_pair_gaussian(__Pyx_memviewslice __pyx_v_x, float __pyx_v_A1, float __pyx_v_A2, float __pyx_v_x0, float __pyx_v_w, float __pyx_v_xsep, CYTHON_UNUSED int __pyx_skip_dispatch) {
  unsigned int __pyx_v_index;
  unsigned int __pyx_v_n;
  __Pyx_memviewslice __pyx_v_y = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = NULL;
  ...
  size_t __pyx_t_11;
  size_t __pyx_t_12;
  __Pyx_RefNannySetupContext("pair_gaussian", 0);

  /* "pyspectools/fast/lineshapes.pyx":127
 *     """
 *     cdef unsigned int index
 *     cdef unsigned int n = x.shape[0]             # <<<<<<<<<<<<<<
 *     cdef double[:] y = np.zeros(n)
 ...
 */
  ...
  /* "pyspectools/fast/lineshapes.pyx":128
 *     cdef unsigned int index
 *     cdef unsigned int n = x.shape[0]
 *     cdef double[:] y = np.zeros(n)             # <<<<<<<<<<<<<<
 *     for index in range(n):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
    __pyx_t_4 = PyMethod_GET_SELF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_y = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "pyspectools/fast/lineshapes.pyx":129
 *     cdef unsigned int n = x.shape[0]
 *     cdef double[:] y = np.zeros(n)
 *     for index in range(n):             # <<<<<<<<<<<<<<
 *         y[index] = exp(-(x[index] - x0 + xsep)**2. / (2. * w**2.)) * (A1 / sqrt(2. * pi * w**2.))
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "pyspectools/fast/lineshapes.pyx":130
 *     cdef double[:] y = np.zeros(n)
 *     for index in range(n):
 *         y[index] = exp(-(x[index] - x0 + xsep)**2. / (2. * w**2.)) * (A1 / sqrt(2. * pi * w**2.))             # <<<<<<<<<<<<<<
 *         y[index] += exp(-(x[index] - x0 - xsep)**2. / (2. * w**2.)) * (A2 / sqrt(2. * pi * w**2.))
 ...
 */
    __pyx_t_9 = __pyx_v_index;
    __pyx_t_10 = __pyx_v_index;
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_10 * __pyx_v_y.strides[0]) )) = (exp(((-pow((((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_9 * __pyx_v_x.strides[0]) ))) - __pyx_v_x0) + __pyx_v_xsep), 2.)) / (2. * pow(((double)__pyx_v_w), 2.)))) * (__pyx_v_A1 / sqrt(((2. * M_PI) * pow(((double)__pyx_v_w), 2.)))));

    /* "pyspectools/fast/lineshapes.pyx":131
 *     for index in range(n):
 *         y[index] = exp(-(x[index] - x0 + xsep)**2. / (2. * w**2.)) * (A1 / sqrt(2. * pi * w**2.))
 *         y[index] += exp(-(x[index] - x0 - xsep)**2. / (2. * w**2.)) * (A2 / sqrt(2. * pi * w**2.))             # <<<<<<<<<<<<<<
 *     return y
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_12 * __pyx_v_y.strides[0]) )) += (exp(((-pow((((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_11 * __pyx_v_x.strides[0]) ))) - __pyx_v_x0) - __pyx_v_xsep), 2.)) / (2. * pow(((double)__pyx_v_w), 2.)))) * (__pyx_v_A2 / sqrt(((2. * M_PI) * pow(((double)__pyx_v_w), 2.)))));
  }

  /* "pyspectools/fast/lineshapes.pyx":132
 *         y[index] = exp(-(x[index] - x0 + xsep)**2. / (2. * w**2.)) * (A1 / sqrt(2. * pi * w**2.))
 *         y[index] += exp(-(x[index] - x0 - xsep)**2. / (2. * w**2.)) * (A2 / sqrt(2. * pi * w**2.))
 *     return y             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_y, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 132, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __PYX_XDEC_MEMVIEW(&__pyx_t_5, 1);
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.pair_gaussian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_y, 1);
  __Pyx_XGIVEREF(__pyx_r);
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_5pair_gaussian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("pair_gaussian (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_A1,&__pyx_n_s_A2,&__pyx_n_s_x0,&__pyx_n_s_w,&__pyx_n_s_xsep,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A1)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("pair_gaussian", 1, 6, 6, 1); __PYX_ERR(0, 105, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pair_gaussian", 1, 6, 6, 2); __PYX_ERR(0, 105, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pair_gaussian", 1, 6, 6, 3); __PYX_ERR(0, 105, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pair_gaussian", 1, 6, 6, 4); __PYX_ERR(0, 105, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_xsep)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pair_gaussian", 1, 6, 6, 5); __PYX_ERR(0, 105, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "pair_gaussian") < 0)) __PYX_ERR(0, 105, __pyx_L3_error)
      }
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 105, __pyx_L3_error)
    __pyx_v_A1 = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_A1 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 105, __pyx_L3_error)
    __pyx_v_A2 = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_A2 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 105, __pyx_L3_error)
    __pyx_v_x0 = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_x0 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 105, __pyx_L3_error)
    __pyx_v_w = __pyx_PyFloat_AsFloat(values[4]); if (unlikely((__pyx_v_w == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 105, __pyx_L3_error)
    __pyx_v_xsep = __pyx_PyFloat_AsFloat(values[5]); if (unlikely((__pyx_v_xsep == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 105, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("pair_gaussian", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 105, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.pair_gaussian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11pyspectools_4fast_10lineshapes_4pair_gaussian(__pyx_self, __pyx_v_x, __pyx_v_A1, __pyx_v_A2, __pyx_v_x0, __pyx_v_w, __pyx_v_xsep);
...
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_4pair_gaussian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_A1, float __pyx_v_A2, float __pyx_v_x0, float __pyx_v_w, float __pyx_v_xsep) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("pair_gaussian", 0);
  ...
  __pyx_t_1 = __pyx_f_11pyspectools_4fast_10lineshapes_pair_gaussian(__pyx_v_x, __pyx_v_A1, __pyx_v_A2, __pyx_v_x0, __pyx_v_w, __pyx_v_xsep, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 105, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pyspectools/fast/lineshapes.pyx":139
 * @cython.cdivision(True)
 * @cython.nonecheck(False)
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_7lorentzian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_lorentzian(__Pyx_memviewslice __pyx_v_x, float __pyx_v_x0, float __pyx_v_gamma, float __pyx_v_A, CYTHON_UNUSED int __pyx_skip_dispatch) {
  unsigned int __pyx_v_n;
  unsigned int __pyx_v_i;
  __Pyx_memviewslice __pyx_v_y = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = NULL;
  ...
  size_t __pyx_t_10;
  size_t __pyx_t_11;
  __Pyx_RefNannySetupContext("lorentzian", 0);

  /* "pyspectools/fast/lineshapes.pyx":158
 * 
 *     """
 *     cdef unsigned int n = x.size             # <<<<<<<<<<<<<<
 *     cdef unsigned int i
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 158, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __Pyx_PyInt_As_unsigned_int(__pyx_t_2); if (unlikely((__pyx_t_3 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 158, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_n = __pyx_t_3;

  /* "pyspectools/fast/lineshapes.pyx":160
 *     cdef unsigned int n = x.size
 *     cdef unsigned int i
 *     cdef double[:] y = np.zeros(n)             # <<<<<<<<<<<<<<
 *     for i in range(n):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 160, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 160, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_4))) {
    __pyx_t_5 = PyMethod_GET_SELF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 160, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_y = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pyspectools/fast/lineshapes.pyx":161
 *     cdef unsigned int i
 *     cdef double[:] y = np.zeros(n)
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         y[i] = gamma**2. / ((x[i] - x0)**2. + gamma**2.)
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "pyspectools/fast/lineshapes.pyx":162
 *     cdef double[:] y = np.zeros(n)
 *     for i in range(n):
 *         y[i] = gamma**2. / ((x[i] - x0)**2. + gamma**2.)             # <<<<<<<<<<<<<<
 *         y[i] *= (A / (pi * gamma))
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_10 * __pyx_v_y.strides[0]) )) = (pow(((double)__pyx_v_gamma), 2.) / (pow(((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_9 * __pyx_v_x.strides[0]) ))) - __pyx_v_x0), 2.) + pow(((double)__pyx_v_gamma), 2.)));

    /* "pyspectools/fast/lineshapes.pyx":163
 *     for i in range(n):
 *         y[i] = gamma**2. / ((x[i] - x0)**2. + gamma**2.)
 *         y[i] *= (A / (pi * gamma))             # <<<<<<<<<<<<<<
 *     return y
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_11 * __pyx_v_y.strides[0]) )) *= (__pyx_v_A / (M_PI * __pyx_v_gamma));
  }

  /* "pyspectools/fast/lineshapes.pyx":164
 *         y[i] = gamma**2. / ((x[i] - x0)**2. + gamma**2.)
 *         y[i] *= (A / (pi * gamma))
 *     return y             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_y, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 164, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_5);
  __PYX_XDEC_MEMVIEW(&__pyx_t_6, 1);
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.lorentzian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_y, 1);
  __Pyx_XGIVEREF(__pyx_r);
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_7lorentzian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("lorentzian (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_x0,&__pyx_n_s_gamma,&__pyx_n_s_A,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x0)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("lorentzian", 1, 4, 4, 1); __PYX_ERR(0, 139, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gamma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lorentzian", 1, 4, 4, 2); __PYX_ERR(0, 139, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lorentzian", 1, 4, 4, 3); __PYX_ERR(0, 139, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "lorentzian") < 0)) __PYX_ERR(0, 139, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 139, __pyx_L3_error)
    __pyx_v_x0 = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_x0 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 139, __pyx_L3_error)
    __pyx_v_gamma = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_gamma == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 139, __pyx_L3_error)
    __pyx_v_A = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_A == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 139, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("lorentzian", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 139, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.lorentzian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11pyspectools_4fast_10lineshapes_6lorentzian(__pyx_self, __pyx_v_x, __pyx_v_x0, __pyx_v_gamma, __pyx_v_A);
...
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_6lorentzian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_x0, float __pyx_v_gamma, float __pyx_v_A) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("lorentzian", 0);
  ...
  __pyx_t_1 = __pyx_f_11pyspectools_4fast_10lineshapes_lorentzian(__pyx_v_x, __pyx_v_x0, __pyx_v_gamma, __pyx_v_A, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 139, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pyspectools/fast/lineshapes.pyx":171
 * @cython.cdivision(True)
 * @cython.nonecheck(False)
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_9first_deriv_lorentzian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_first_deriv_lorentzian(__Pyx_memviewslice __pyx_v_x, float __pyx_v_x0, float __pyx_v_gamma, float __pyx_v_A, CYTHON_UNUSED int __pyx_skip_dispatch) {
  unsigned int __pyx_v_n;
  unsigned int __pyx_v_i;
  __Pyx_memviewslice __pyx_v_y = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = NULL;
  ...
  size_t __pyx_t_11;
  size_t __pyx_t_12;
  __Pyx_RefNannySetupContext("first_deriv_lorentzian", 0);

  /* "pyspectools/fast/lineshapes.pyx":188
 ...
 *     cdef double[:] y = np.zeros(n)
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_x, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 188, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 188, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __Pyx_PyInt_As_unsigned_int(__pyx_t_2); if (unlikely((__pyx_t_3 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 188, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_n = __pyx_t_3;

  /* "pyspectools/fast/lineshapes.pyx":190
 *     cdef unsigned int n = x.size
 *     cdef unsigned int i
 *     cdef double[:] y = np.zeros(n)             # <<<<<<<<<<<<<<
 *     for i in range(n):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 190, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_y = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pyspectools/fast/lineshapes.pyx":191
 *     cdef unsigned int i
 *     cdef double[:] y = np.zeros(n)
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         y[i] = (-2. * A * gamma**3. * (x[i] - x0))
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "pyspectools/fast/lineshapes.pyx":192
 *     cdef double[:] y = np.zeros(n)
 *     for i in range(n):
 *         y[i] = (-2. * A * gamma**3. * (x[i] - x0))             # <<<<<<<<<<<<<<
 *         y[i] /= (pi * (gamma**2. + (x[i] - x0)**2.)**2.)
 ...
 */
    __pyx_t_9 = __pyx_v_i;
    __pyx_t_10 = __pyx_v_i;
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_10 * __pyx_v_y.strides[0]) )) = (((-2. * __pyx_v_A) * pow(((double)__pyx_v_gamma), 3.)) * ((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_9 * __pyx_v_x.strides[0]) ))) - __pyx_v_x0));

    /* "pyspectools/fast/lineshapes.pyx":193
 *     for i in range(n):
 *         y[i] = (-2. * A * gamma**3. * (x[i] - x0))
 *         y[i] /= (pi * (gamma**2. + (x[i] - x0)**2.)**2.)             # <<<<<<<<<<<<<<
 *     return y
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_12 * __pyx_v_y.strides[0]) )) /= (M_PI * pow((pow(((double)__pyx_v_gamma), 2.) + pow(((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_11 * __pyx_v_x.strides[0]) ))) - __pyx_v_x0), 2.)), 2.));
  }

  /* "pyspectools/fast/lineshapes.pyx":194
 *         y[i] = (-2. * A * gamma**3. * (x[i] - x0))
 *         y[i] /= (pi * (gamma**2. + (x[i] - x0)**2.)**2.)
 *     return y             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_y, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 194, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_5);
  __PYX_XDEC_MEMVIEW(&__pyx_t_6, 1);
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.first_deriv_lorentzian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_y, 1);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_9first_deriv_lorentzian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_11pyspectools_4fast_10lineshapes_8first_deriv_lorentzian[] = "\n        Cython implementation of the first derivative lineshape of a Lorenz-\n        tian function.\n\n        Parameters\n        ----------\n        x: np.ndarray\n            Numpy 1D array containing x values to evaluate\n        x0, gamma, A: float\n            Parameters of the first-derivative Lorentzian function\n\n        Returns\n        -------\n        y: np.ndarray\n            Numpy 1D array containing y values for the first-derivative\n    ";
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_9first_deriv_lorentzian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  float __pyx_v_x0;
  float __pyx_v_gamma;
  float __pyx_v_A;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("first_deriv_lorentzian (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_x0,&__pyx_n_s_gamma,&__pyx_n_s_A,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x0)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("first_deriv_lorentzian", 1, 4, 4, 1); __PYX_ERR(0, 171, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gamma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("first_deriv_lorentzian", 1, 4, 4, 2); __PYX_ERR(0, 171, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("first_deriv_lorentzian", 1, 4, 4, 3); __PYX_ERR(0, 171, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "first_deriv_lorentzian") < 0)) __PYX_ERR(0, 171, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 171, __pyx_L3_error)
    __pyx_v_x0 = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_x0 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 171, __pyx_L3_error)
    __pyx_v_gamma = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_gamma == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 171, __pyx_L3_error)
    __pyx_v_A = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_A == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 171, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("first_deriv_lorentzian", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 171, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.first_deriv_lorentzian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11pyspectools_4fast_10lineshapes_8first_deriv_lorentzian(__pyx_self, __pyx_v_x, __pyx_v_x0, __pyx_v_gamma, __pyx_v_A);
...
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_8first_deriv_lorentzian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_x0, float __pyx_v_gamma, float __pyx_v_A) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("first_deriv_lorentzian", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_x.memview)) { __Pyx_RaiseUnboundLocalError("x"); __PYX_ERR(0, 171, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_11pyspectools_4fast_10lineshapes_first_deriv_lorentzian(__pyx_v_x, __pyx_v_x0, __pyx_v_gamma, __pyx_v_A, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 171, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pyspectools/fast/lineshapes.pyx":201
 * @cython.cdivision(True)
 * @cython.nonecheck(False)
...
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_11sec_deriv_lorentzian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11pyspectools_4fast_10lineshapes_sec_deriv_lorentzian(__Pyx_memviewslice __pyx_v_x, float __pyx_v_x0, float __pyx_v_gamma, float __pyx_v_A, CYTHON_UNUSED int __pyx_skip_dispatch) {
  unsigned int __pyx_v_n;
  unsigned int __pyx_v_i;
  __Pyx_memviewslice __pyx_v_y = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = NULL;
  ...
  size_t __pyx_t_12;
  size_t __pyx_t_13;
  __Pyx_RefNannySetupContext("sec_deriv_lorentzian", 0);

  /* "pyspectools/fast/lineshapes.pyx":218
 ...
 *     cdef double[:] y = np.zeros(n)
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_x, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 218, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 218, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "pyspectools/fast/lineshapes.pyx":220
 *     cdef unsigned int n = x.size
 *     cdef unsigned int i
 *     cdef double[:] y = np.zeros(n)             # <<<<<<<<<<<<<<
 *     for i in range(n):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 220, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 220, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_y = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pyspectools/fast/lineshapes.pyx":221
 *     cdef unsigned int i
 *     cdef double[:] y = np.zeros(n)
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         y[i] = (-2. * A * gamma**3.) / (pi * (gamma**2. + (x[i] - x0)**2.)**2.)
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "pyspectools/fast/lineshapes.pyx":222
 *     cdef double[:] y = np.zeros(n)
 *     for i in range(n):
 *         y[i] = (-2. * A * gamma**3.) / (pi * (gamma**2. + (x[i] - x0)**2.)**2.)             # <<<<<<<<<<<<<<
 *         y[i] += (8. * A * gamma**3. * (x[i] - x0)**2.) / (pi * (gamma**2. + (x[i] - x0**2.)**3.))
 ...
 */
    __pyx_t_9 = __pyx_v_i;
    __pyx_t_10 = __pyx_v_i;
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_10 * __pyx_v_y.strides[0]) )) = (((-2. * __pyx_v_A) * pow(((double)__pyx_v_gamma), 3.)) / (M_PI * pow((pow(((double)__pyx_v_gamma), 2.) + pow(((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_9 * __pyx_v_x.strides[0]) ))) - __pyx_v_x0), 2.)), 2.)));

    /* "pyspectools/fast/lineshapes.pyx":223
 *     for i in range(n):
 *         y[i] = (-2. * A * gamma**3.) / (pi * (gamma**2. + (x[i] - x0)**2.)**2.)
 *         y[i] += (8. * A * gamma**3. * (x[i] - x0)**2.) / (pi * (gamma**2. + (x[i] - x0**2.)**3.))             # <<<<<<<<<<<<<<
 *     return y
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_13 * __pyx_v_y.strides[0]) )) += ((((8. * __pyx_v_A) * pow(((double)__pyx_v_gamma), 3.)) * pow(((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_11 * __pyx_v_x.strides[0]) ))) - __pyx_v_x0), 2.)) / (M_PI * (pow(((double)__pyx_v_gamma), 2.) + pow(((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_12 * __pyx_v_x.strides[0]) ))) - pow(((double)__pyx_v_x0), 2.)), 3.))));
  }

  /* "pyspectools/fast/lineshapes.pyx":224
 *         y[i] = (-2. * A * gamma**3.) / (pi * (gamma**2. + (x[i] - x0)**2.)**2.)
 *         y[i] += (8. * A * gamma**3. * (x[i] - x0)**2.) / (pi * (gamma**2. + (x[i] - x0**2.)**3.))
 *     return y             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_y, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 224, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_5);
  __PYX_XDEC_MEMVIEW(&__pyx_t_6, 1);
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.sec_deriv_lorentzian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_y, 1);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_11sec_deriv_lorentzian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_11pyspectools_4fast_10lineshapes_10sec_deriv_lorentzian[] = "\n        Cython implementation of the second derivative lineshape of a Lorenz-\n        tian function.\n\n        Parameters\n        ----------\n        x: np.ndarray\n            Numpy 1D array containing x values to evaluate\n        x0, gamma, A: float\n            Parameters of the first-derivative Lorentzian function\n\n        Returns\n        -------\n        y: np.ndarray\n            Numpy 1D array containing y values for the second-derivative\n    ";
static PyObject *__pyx_pw_11pyspectools_4fast_10lineshapes_11sec_deriv_lorentzian(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  float __pyx_v_x0;
  float __pyx_v_gamma;
  float __pyx_v_A;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("sec_deriv_lorentzian (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_x0,&__pyx_n_s_gamma,&__pyx_n_s_A,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x0)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("sec_deriv_lorentzian", 1, 4, 4, 1); __PYX_ERR(0, 201, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gamma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("sec_deriv_lorentzian", 1, 4, 4, 2); __PYX_ERR(0, 201, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("sec_deriv_lorentzian", 1, 4, 4, 3); __PYX_ERR(0, 201, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "sec_deriv_lorentzian") < 0)) __PYX_ERR(0, 201, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 201, __pyx_L3_error)
    __pyx_v_x0 = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_x0 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 201, __pyx_L3_error)
    __pyx_v_gamma = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_gamma == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 201, __pyx_L3_error)
    __pyx_v_A = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_A == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 201, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("sec_deriv_lorentzian", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 201, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyspectools.fast.lineshapes.sec_deriv_lorentzian", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11pyspectools_4fast_10lineshapes_10sec_deriv_lorentzian(__pyx_self, __pyx_v_x, __pyx_v_x0, __pyx_v_gamma, __pyx_v_A);
...
static PyObject *__pyx_pf_11pyspectools_4fast_10lineshapes_10sec_deriv_lorentzian(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_x0, float __pyx_v_gamma, float __pyx_v_A) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("sec_deriv_lorentzian", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_x.memview)) { __Pyx_RaiseUnboundLocalError("x"); __PYX_ERR(0, 201, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_11pyspectools_4fast_10lineshapes_sec_deriv_lorentzian(__pyx_v_x, __pyx_v_x0, __pyx_v_gamma, __pyx_v_A, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 201, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pyspectools.fast.lineshapes.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyspectools.fast.lineshapes.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyspectools.fast.lineshapes.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyspectools.fast.lineshapes._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"gaussian", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11pyspectools_4fast_10lineshapes_1gaussian, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11pyspectools_4fast_10lineshapes_gaussian},
  {"multi_gaussian", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11pyspectools_4fast_10lineshapes_3multi_gaussian, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11pyspectools_4fast_10lineshapes_2multi_gaussian},
  {"pair_gaussian", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11pyspectools_4fast_10lineshapes_5pair_gaussian, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11pyspectools_4fast_10lineshapes_4pair_gaussian},
  {"lorentzian", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11pyspectools_4fast_10lineshapes_7lorentzian, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11pyspectools_4fast_10lineshapes_6lorentzian},
  {"first_deriv_lorentzian", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11pyspectools_4fast_10lineshapes_9first_deriv_lorentzian, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11pyspectools_4fast_10lineshapes_8first_deriv_lorentzian},
  {"sec_deriv_lorentzian", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11pyspectools_4fast_10lineshapes_11sec_deriv_lorentzian, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11pyspectools_4fast_10lineshapes_10sec_deriv_lorentzian},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_lineshapes(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_lineshapes},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_xsep, __pyx_k_xsep, sizeof(__pyx_k_xsep), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initlineshapes(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initlineshapes(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_lineshapes(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_lineshapes(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_lineshapes(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'lineshapes' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_lineshapes(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("lineshapes", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pyspectools__fast__lineshapes) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyspectools.fast.lineshapes")) {
      if (unlikely(PyDict_SetItemString(modules, "pyspectools.fast.lineshapes", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pyspectools/fast/lineshapes.pyx":2
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyspectools.fast.lineshapes", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyspectools.fast.lineshapes");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
